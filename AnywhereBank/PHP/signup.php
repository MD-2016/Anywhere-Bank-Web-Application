<?php
   ...
   if(isset($_POST['submit']))
   {
	   ...
	   if(validateImportantFields($fname, $lname, $accountNum, $phone, $email, $pass, $birthdate))
	   {
			...
			else
			{
				...
				{
					$stmt->bind_param("sssssss",$email, $fname, $lname, $phone, $passhash, $resultDate, $contact);
					$stmt->execute();
					$stmt->close();
